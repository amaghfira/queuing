...
<head>
    ...
    <title><?php echo ucwords(str_replace('_',' ',$page)) ?> | Sistem Antrean BPS Kaltim - Cashier - Side</title>
...
<body>
    <nav class="nav navbar navbar-light bg-primary bg-gradient py-2 text-light fs-4 fw-bold">
        <marquee behavior="" direction="">
            <span class="mx-5">Selamat datang di BPS Provinsi Kalimantan Timur.</span>
            <span class="mx-5">Silakan menunggu nomor antrean dipanggil. Terima kasih.</span>
        </marquee>
    </nav>
    <main>
