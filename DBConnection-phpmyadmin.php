<?php
if(!defined('db_host')) define('db_host', 'localhost'); // Modify host if necessary
if(!defined('db_user')) define('db_user', 'root'); // Modify username
if(!defined('db_pass')) define('db_pass', ''); // Modify password
if(!defined('db_name')) define('db_name', 'cashier_queuing_db'); // Modify database name
